...
<html>
  ...
  <body>
   ...
   <form role="form" class="form-horizontal" action="modifyPasswordServlet" method="post" onSubmit="return check()">
    
    <div class="form-group">
		<label for="password" class="col-md-2 col-md-offset-2 control-label">密码：</label>
		<div class="col-md-3">
		<input type="password" class="form-control col-md-4" id="password" name="password" placeholder="请输入6~10位密码" maxlength="10">	
		</div>
	...
	<div class="form-group">
		...
		<div class="col-md-3" >
		<input type="password" class="form-control col-md-4" id="passwordRep" name="passwordRep" placeholder="请再输入一次密码">
	    </div>
