...
<%@ include file="/WEB-INF/views/navigation.jsp"%>
	...
	<div class="form-group">
		...
		<div class="col-sm-3" >
		<input type="password" class="form-control col-xs-4" id="password" name="password" placeholder="请输入密码">
	    </div>
	</div>
	<div class="form-group">
		<label for="passwordRep" class="col-sm-2 col-sm-offset-2 control-label">密码确认：</label>
		<div class="col-sm-3" >
		<input type="password" class="form-control col-xs-4" id="passwordRep" name="passwordRep" placeholder="请再输入一次密码">
	    </div>
	</div>
