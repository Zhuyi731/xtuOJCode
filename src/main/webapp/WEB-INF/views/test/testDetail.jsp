...
<div class="functionNav" align="center">
    <table class="table table-hover text-info">
        <tbody>
        <tr>
            <td class="col-md-2 col-sm-2 "><a class="btn btn-danger glyphicon glyphicon-arrow-left"
                                              onclick='window.history.go(-1)'>Go Back</a></td>
            <td class="col-md-2 col-sm-2"><a class="btn btn-primary"
                                             href="/test/standing/${vo.entityList[0].contestId}">Standing</a></td>
    ...
    <table class="table table-hover table-border" style="width: 800px;">
        ...
        <c:forEach items="${vo.entityList}" var="entity">
            <tr>
                ...
                <td>
                    <a href="/test/testProDetail/${entity.contestId}?contestId=${entity.contestId}&no=${entity.no}">${entity.title}</a>
                </td>
